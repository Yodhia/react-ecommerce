// an atom is one piece of data that you want to share accross different componet (similar to state)
import { atom, useAtom} from 'jotai';

// create an atom for the flash message and export it for other components to use
...
export const useFlashMessage = () => {
    ...
    //the showMessage function provides a standardize way to set the flash message
